...
}), console.info("%c MUSIC-FLOW-CARD %c v2026.09.17.4 ", "background: #444; color: #fff; border-radius: 3px 0 0 3px; padding: 2px 0;", "background: #10b981; color: #fff; border-radius: 0 3px 3px 0; padding: 2px 0;");
//#endregion
